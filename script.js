...
let imgArr = ['meteor-svgrepo-com.svg','meteor.svg','coronavirus.svg','virus.svg'];
let space = new Image();
space.src = 'spx.png';
let idx = 0;
const meteor = new Image();
meteor.src =imgArr[idx];
const saviour = new Image();
saviour.src = 'captain-america.svg'
...
class Player{
    ...
    draw(){
        ...
        // ctx.fill();
        ctx.drawImage(saviour,this.x,this.y,50,50)
    }
}
...
class Enemy{
    ...
    draw(){
        ...
        //     pattern = ctx.createPatttern(star_img, 'repeat');
        // };
        ...
        ctx.drawImage(meteor,this.x,this.y,40,40);
    }
            ...
            if(dist-enemy.radius-projectile.radius<1){
                ...
                if(enemy.radius - 10 > 5){
                    ...
                    setTimeout(()=>{
                        ...
                        projectiles.splice(projectileIndex,1);
                    },0);//to remove splash effect so that it is not drawn in the next farame
                }
